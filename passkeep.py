...
class PassKeep(object):
    ...
    def add(self):
        ...
        parser.add_argument('--alias', required=True, action='store',
                            help=HelpString.getAddString('arg_alias'))
        parser.add_argument('--website', required=True, action='store',
                            help=HelpString.getAddString('arg_website'))
        parser.add_argument('--username', required=True, action='store',
                            help=HelpString.getAddString('arg_username'))
        group = parser.add_mutually_exclusive_group(required=True)
        group.add_argument('--password', action='store',
                           help=HelpString.getAddString('arg_password'))
    ...
    def remove(self):
        ...
        parser.add_argument('--alias', action='store',
                            help=HelpString.getRemoveString('arg_alias'))
        parser.add_argument('--website', action='store',
                            help=HelpString.getRemoveString('arg_website'))
        args = parser.parse_args(sys.argv[2:])
    ...
    def show(self):
        ...
        parser.add_argument('--alias', action='store',
                            help=HelpString.getShowString('arg_alias'))
        parser.add_argument('--website', action='store',
                            help=HelpString.getShowString('arg_website'))
        args = parser.parse_args(sys.argv[2:])
...
*********************************
    ...
    def generate(self):
        ...
        # NOT any arguments
        parser.add_argument('--count', action='store', default=8,
                            type=int, help=HelpString.getGenerateString('arg_count'))
        parser.add_argument('--charset', action='store',
    ...
    def config(self):
        ...
        # NOT any arguments
        group = parser.add_mutually_exclusive_group(required=True)
        group.add_argument('--set', action='store', choices=[
                           'PUBLIC_KEY', 'SECRET_KEY', 'CONF_PATH'], type=str, help=HelpString.getConfigString('arg_set'))
        group.add_argument('--get', action='store',
                           help=HelpString.getConfigString('arg_get'))
        parser.add_argument('--value', action='store',
                            help=HelpString.getConfigString('arg_value'))
        args = parser.parse_args(sys.argv[2:])
